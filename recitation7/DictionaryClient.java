 ...
 * @author Tim Pierson, Dartmouth CS 10, Fall 2024 - fixed socket initialization issue
 * @author Tim Pierson, Dartmouth CS 10, provided for Winter 2025
 */
public class DictionaryClient {
    public static void main(String[] args) throws Exception {
        String host = "172.27.170.160"; //"localhost" or something like "129.170.212.159"
        int port = 4242;
        ...
        while ((line = in.readLine()) != null) {
            ...
            String name = console.nextLine(); // blocking activity --> waits until the user types something
            out.println(name);
        }
