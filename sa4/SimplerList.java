/**
 * A simpler interface for a generic List ADT without an iterator (our SimpleList interface has an iterator)
 * @author: Tim Pierson, Dartmouth CS10, Winter 2025 (based on interface from prior terms)
 */
