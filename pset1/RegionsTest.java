...
public class RegionsTest {
    ...
    public static void main(String[] args) {
        new RegionsTest("smiley", new RegionFinder(ImageIOLibrary.loadImage("pset1/smiley.png")), new Color(0, 0, 0));
        new RegionsTest("baker", new RegionFinder(ImageIOLibrary.loadImage("pset1/baker.png")), new Color(130, 100, 100));
    }
}
